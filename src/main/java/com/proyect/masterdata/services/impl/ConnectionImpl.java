...
public class ConnectionImpl implements IConnection {
    ...
    @Override
    public ResponseSuccess saveAll(List<String> urls, String user)
    ...
    @Override
    public Page<ConnectionDTO> list(String url, String sort, String sortColumn, Integer pageNumber, Integer pageSize)
            throws BadRequestExceptions {
        Page<Connection> connectionPage;
        try {
            connectionPage = connectionRepositoryCustom.searchForConnection(url, sort, sortColumn, pageNumber, pageSize,
                    true);
        } catch (RuntimeException e) {
            log.error(e);
    ...
    @Override
    public Page<ConnectionDTO> listStatusFalse(String url, String sort, String sortColumn, Integer pageNumber,
