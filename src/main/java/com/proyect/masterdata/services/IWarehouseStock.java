...
public interface IWarehouseStock {
        ResponseSuccess in(Warehouse warehouse, Product product, Integer quantity, User user)
                        throws InternalErrorExceptions, BadRequestExceptions;
        ResponseSuccess out(Warehouse warehouse, Product product, Integer quantity, User user)
                        throws InternalErrorExceptions, BadRequestExceptions;
