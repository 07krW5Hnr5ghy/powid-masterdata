...
public interface IRole {
    ...
    List<RoleDTO> listUserRole() throws BadRequestExceptions;

    Page<RoleDTO> list(String name, String user, String sort, String sortColumn, Integer pageNumber, Integer pageSize)
