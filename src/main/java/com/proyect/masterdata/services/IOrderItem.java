...
public interface IOrderItem {
    ...
    CompletableFuture<ResponseSuccess> preparateOrderItemCheck (UUID orderItemId,String tokenUser,Integer preparedProducts) throws InternalErrorExceptions,BadRequestExceptions;
}
