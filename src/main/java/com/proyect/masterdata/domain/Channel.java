...
public class Channel {
        ...
        @GenericGenerator(name = "sequence-channel", strategy = "org.hibernate.id.enhanced.SequenceStyleGenerator", parameters = {
        ...
        @ManyToOne
        @JoinColumn(name = "usuario", columnDefinition = "user", insertable = false, updatable = false)
