...
public class StockReturnRepositoryCustomImpl implements StockReturnRepositoryCustom {
    ...
    @Override
    public Page<StockReturn> searchForStockReturn(Long purchaseId, Long clientId, String sort, String sortColumn, Integer pageNumber, Integer pageSize, Boolean status) {
