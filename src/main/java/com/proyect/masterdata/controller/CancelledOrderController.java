...
public class CancelledOrderController {
    ...
    public ResponseEntity<Page<CancelledOrderDTO>> list(
        ...
        CompletableFuture<Page<CancelledOrderDTO>> result = iCancelledOrder.list(orderId,user,registrationStartDate,registrationEndDate,updateStartDate,updateEndDate,sort,sortColumn,pageNumber,pageSize);
        return new ResponseEntity<>(result.get(),HttpStatus.OK);
    }
}
