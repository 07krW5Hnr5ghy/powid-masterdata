...
import com.proyect.masterdata.services.impl.ProvinceImpl;
...
public class ProvinceController {
    private final ProvinceImpl iProvince;

    @Operation(summary = "Lista las provincias",
    ...
    @GetMapping()
    public ResponseEntity<List<MasterListDTO>> listProvinces() throws BadRequestExceptions {
        List<MasterListDTO> result = iProvince.listRecords();
